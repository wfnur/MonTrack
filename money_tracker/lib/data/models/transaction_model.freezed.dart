...
class _$TransactionModelImpl implements _TransactionModel {
  const _$TransactionModelImpl({
    ...
    required final List<String> labelIds,
    this.note,
  ...
  @override
  String toString() {
    return 'TransactionModel(id: $id, type: $type, amount: $amount, date: $date, categoryId: $categoryId, labelIds: $labelIds, note: $note, pocketId: $pocketId, createdAt: $createdAt)';
  }
